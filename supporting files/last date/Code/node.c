...
void initializeNodes(){
	...
	MPI_Pack( mac_address, 20, MPI_UNSIGNED_CHAR, packbuf, packsize, &position, MPI_COMM_WORLD );
	MPI_Pack( ip_address, 20, MPI_UNSIGNED_CHAR, packbuf, packsize, &position, MPI_COMM_WORLD );
